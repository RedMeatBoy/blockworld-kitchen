...
const W = {
  ...
  // ===== expansion 2: condiments, spices, sauces, cheeses & funny cuttables =====
  SALT:       { dish: 'Pinch of Salt', emoji: '🧂', color: 0xf6f3ec },
  GOO:        { dish: 'Green Goo Glop', emoji: '🟢', color: 0x6bb35e },
  BLOB:       { dish: 'Wobbly Blob', emoji: '🫧', color: 0x6bb3d9 },
  SPAM:       { dish: 'Mystery Spam', emoji: '🥫', color: 0xe89aa4 },
  BUGS:       { dish: 'Crunchy Bug Snacks', emoji: '🐛', color: 0x6b9b3f },
  STEW:       { dish: 'Hearty Stew', emoji: '🍲', color: 0x8a5f3b },
  MAYO:       { dish: 'Garlic Mayo Dip', emoji: '🥚', color: 0xf6f3ec },
  SALSA:      { dish: 'Zesty Salsa Bowl', emoji: '🍅', color: 0xd9453a },
  RANCH:      { dish: 'Ranch Drizzle', emoji: '🥛', color: 0xf2ede0 },
  SAUCE:      { dish: 'Secret Sauce', emoji: '🥫', color: 0xd9453a },
  DILL:       { dish: 'Dilly Dill Sprigs', emoji: '🌿', color: 0x6bb35e },
  SAGE:       { dish: 'Garden Sage', emoji: '🌿', color: 0x9bc96b },
  MACE:       { dish: 'Ground Mace', emoji: '🟠', color: 0xe8843b },
  BRIE:       { dish: 'Baked Brie', emoji: '🧀', color: 0xf2ead9 },
  FETA:       { dish: 'Feta Crumble', emoji: '🧀', color: 0xf6f3ec },
  TOFU:       { dish: 'Crispy Tofu Cubes', emoji: '🧊', color: 0xf2ede0 },
  GYRO:       { dish: 'Greek Gyro', emoji: '🥙', color: 0xd9b27a },
  BEET:       { dish: 'Ruby Beet', emoji: '🟣', color: 0xa32b5a },
  OKRA:       { dish: 'Fried Okra', emoji: '🥒', color: 0x6bb35e },
  WORMS:      { dish: 'Gummy Worms', emoji: '🪱', color: 0xe86b9a },
  SLIME:      { dish: 'Slippery Slime', emoji: '🟩', color: 0x6bd96b },
  GUMMY:      { dish: 'Giant Gummy Bear', emoji: '🧸', color: 0xe8543a },
  GIANT:      { dish: 'Giant Meatball', emoji: '🍖', color: 0xa3543b },
  FROG:       { dish: 'Frog Legs', emoji: '🐸', color: 0x6bb35e },
  GLOOP:      { dish: 'Purple Gloop', emoji: '🟣', color: 0x8a4fb3 },
  DATE:       { dish: 'Sticky Dates', emoji: '🟤', color: 0x8a5f3b },
  WINGS:      { dish: 'Spicy Wings', emoji: '🍗', color: 0xd9743b },
  FRIES:      { dish: 'Crispy Fries', emoji: '🍟', color: 0xf2c84b },
  ROLLS:      { dish: 'Spring Rolls', emoji: '🥟', color: 0xe8d9b3 },
  PUNCH:      { dish: 'Fruit Punch', emoji: '🥤', color: 0xd93a6b },
  SLUSH:      { dish: 'Blue Slushie', emoji: '🧊', color: 0x5ab2e8 },
  SHAKE:      { dish: 'Berry Shake', emoji: '🥤', color: 0xe89ac4 },
  COCOA:      { dish: 'Hot Cocoa', emoji: '☕', color: 0x6b4226 },
  GRAVY:      { dish: 'Gravy Boat', emoji: '🍛', color: 0x8a5f3b },
  SYRUP:      { dish: 'Maple Syrup Pour', emoji: '🍁', color: 0xb3651e },
  RELISH:     { dish: 'Pickle Relish', emoji: '🥒', color: 0x6b9b3f },
  PESTO:      { dish: 'Basil Pesto Swirl', emoji: '🌿', color: 0x5f9b4f },
  HUMMUS:     { dish: 'Creamy Hummus', emoji: '🧆', color: 0xe8d9b3 },
  CURRY:      { dish: 'Golden Curry', emoji: '🍛', color: 0xe8893b },
  BROTH:      { dish: 'Steamy Broth', emoji: '🍜', color: 0xd9b27a },
  CHILI:      { dish: 'Hearty Chili', emoji: '🌶️', color: 0xb33b2c },
  BASIL:      { dish: 'Fresh Basil', emoji: '🌿', color: 0x4f9b3f },
  GINGER:     { dish: 'Ginger Root', emoji: '🫚', color: 0xe8c98a },
  CLOVE:      { dish: 'Spiced Cloves', emoji: '🟫', color: 0x6b4226 },
  CHIVE:      { dish: 'Chopped Chives', emoji: '🌱', color: 0x5f9b4f },
  GOUDA:      { dish: 'Smoked Gouda', emoji: '🧀', color: 0xe8b45e },
  SWISS:      { dish: 'Swiss Slices', emoji: '🧀', color: 0xf2dc8a },
  BAGEL:      { dish: 'Toasted Bagel', emoji: '🥯', color: 0xd9a662 },
  DONUT:      { dish: 'Glazed Donut', emoji: '🍩', color: 0xe89ac4 },
  SUSHI:      { dish: 'Sushi Roll', emoji: '🍣', color: 0xf2efe4 },
  KEBAB:      { dish: 'Grilled Kebab', emoji: '🍢', color: 0xa3543b },
  NACHOS:     { dish: 'Loaded Nachos', emoji: '🧀', color: 0xe8c25a },
  JERKY:      { dish: 'Beef Jerky', emoji: '🥩', color: 0x8a4326 },
  SALAMI:     { dish: 'Salami Slices', emoji: '🍖', color: 0xc4304a },
  CELERY:     { dish: 'Celery Sticks', emoji: '🥬', color: 0x9bc96b },
  SQUASH:     { dish: 'Roasted Squash', emoji: '🎃', color: 0xe8a83b },
  ORANGE:     { dish: 'Orange Wedges', emoji: '🍊', color: 0xe8843b },
  BRAINS:     { dish: 'Jiggly Brain Mold', emoji: '🧠', color: 0xe89ac4 },
  STINKY:     { dish: 'Stinky Cheese', emoji: '🧀', color: 0x9bc96b },
  TONGUE:     { dish: 'Beef Tongue Slices', emoji: '👅', color: 0xd96b7a },
  SNAIL:      { dish: 'Garlic Snails', emoji: '🐌', color: 0x9b8b6b },
  SQUID:      { dish: 'Crispy Squid Rings', emoji: '🦑', color: 0xe8d9c0 },
  RAMEN:      { dish: 'Steamy Ramen', emoji: '🍜', color: 0xe8cf8a },
  SUNDAE:     { dish: 'Fudge Sundae', emoji: '🍨', color: 0xf2e8dc },
  FUDGE:      { dish: 'Chocolate Fudge', emoji: '🍫', color: 0x6b4226 },
  WAFER:      { dish: 'Crispy Wafer', emoji: '🍪', color: 0xe8d9b3 },
  SCONE:      { dish: 'Cream Scone', emoji: '🥐', color: 0xe8c98a },
  CREPE:      { dish: 'Folded Crepe', emoji: '🥞', color: 0xe8d9b3 },
  ALMOND:     { dish: 'Toasted Almonds', emoji: '🌰', color: 0xc9925e },
  WALNUT:     { dish: 'Walnut Halves', emoji: '🌰', color: 0x8a5f3b },
  PECAN:      { dish: 'Candied Pecans', emoji: '🌰', color: 0xa3653b },
  RAISIN:     { dish: 'Sweet Raisins', emoji: '🍇', color: 0x6b4226 },
  PRUNE:      { dish: 'Stewed Prunes', emoji: '🟣', color: 0x4a2a4f },
  CHERRY:     { dish: 'Bright Cherry', emoji: '🍒', color: 0xc4304a },
  LATTE:      { dish: 'Foamy Latte', emoji: '☕', color: 0xc9a25e },
  CIDER:      { dish: 'Spiced Cider', emoji: '🍎', color: 0xc9853b },
  MOCHA:      { dish: 'Mocha Swirl', emoji: '☕', color: 0x6b4226 },
  WAFFLE:     { dish: 'Single Waffle', emoji: '🧇', color: 0xdfae55 },
  AIOLI:      { dish: 'Lemon Aioli', emoji: '🧄', color: 0xf2e8c0 },
  CHUTNEY:    { dish: 'Mango Chutney', emoji: '🥭', color: 0xe8893b },
  VINEGAR:    { dish: 'Splash of Vinegar', emoji: '🍾', color: 0xd9b27a },
  WASABI:     { dish: 'Fiery Wasabi', emoji: '🟢', color: 0x6bb35e },
  GUMBO:      { dish: 'Bayou Gumbo', emoji: '🍲', color: 0x8a4326 },
  THYME:      { dish: 'Sprig of Thyme', emoji: '🌿', color: 0x6b9b4f },
  CUMIN:      { dish: 'Warm Cumin', emoji: '🟤', color: 0xb3793b },
  NUTMEG:     { dish: 'Grated Nutmeg', emoji: '🌰', color: 0x8a5f3b },
  PARSLEY:    { dish: 'Parsley Sprinkle', emoji: '🌿', color: 0x4f9b3f },
  CHEDDAR:    { dish: 'Sharp Cheddar', emoji: '🧀', color: 0xe8843b },
  RAVIOLI:    { dish: 'Cheesy Ravioli', emoji: '🥟', color: 0xe8d9b3 },
  SAUSAGE:    { dish: 'Sizzling Sausage', emoji: '🌭', color: 0xa3543b },
  BOLOGNA:    { dish: 'Bologna Round', emoji: '🥪', color: 0xe89aa4 },
  LOBSTER:    { dish: 'Lobster Tail', emoji: '🦞', color: 0xe8744f },
  BRISKET:    { dish: 'Smoky Brisket', emoji: '🥩', color: 0x8a4326 },
  SHALLOT:    { dish: 'Sliced Shallot', emoji: '🧅', color: 0xc99a8a },
  FENNEL:     { dish: 'Shaved Fennel', emoji: '🧅', color: 0xd9e8c0 },
  APRICOT:    { dish: 'Sweet Apricot', emoji: '🍑', color: 0xe8a83b },
  PAPAYA:     { dish: 'Papaya Boat', emoji: '🧡', color: 0xe8893b },
  GUAVA:      { dish: 'Pink Guava', emoji: '🍈', color: 0xd96b7a },
  PARSNIP:    { dish: 'Roasted Parsnip', emoji: '🥕', color: 0xe8d9b3 },
  EYEBALL:    { dish: 'Candy Eyeballs', emoji: '👁️', color: 0xf6f3ec },
  MYSTERY:    { dish: 'Mystery Meat Loaf', emoji: '❓', color: 0x9b7a6b },
  CRICKET:    { dish: 'Cricket Crunch Bar', emoji: '🦗', color: 0x6b5f3b },
  DURIAN:     { dish: 'Stinky Durian', emoji: '🥥', color: 0xc9a25e },
  HAGGIS:     { dish: 'Highland Haggis', emoji: '🏴', color: 0x6b4226 },
  SPROUT:     { dish: 'Brussels Sprouts', emoji: '🥬', color: 0x5f9b4f },
  QUICHE:     { dish: 'Veggie Quiche', emoji: '🥧', color: 0xe8c25a },
  SORBET:     { dish: 'Berry Sorbet', emoji: '🍧', color: 0xe86b9a },
  GELATO:     { dish: 'Creamy Gelato', emoji: '🍨', color: 0xf2d5e0 },
  PARFAIT:    { dish: 'Yogurt Parfait', emoji: '🍦', color: 0xf2e8dc },
  TOFFEE:     { dish: 'Buttery Toffee', emoji: '🍬', color: 0xb3793b },
  CARAMEL:    { dish: 'Gooey Caramel', emoji: '🍮', color: 0xc9853b },
  ECLAIR:     { dish: 'Chocolate Eclair', emoji: '🍫', color: 0x6b4226 },
  COBBLER:    { dish: 'Peach Cobbler', emoji: '🥧', color: 0xe8a83b },
  TRIFLE:     { dish: 'Berry Trifle', emoji: '🍨', color: 0xe89ac4 },
  CASHEW:     { dish: 'Roasted Cashews', emoji: '🥜', color: 0xe8d9b3 },
  LENTIL:     { dish: 'Lentil Soup', emoji: '🥣', color: 0xc9853b },
  PANINI:     { dish: 'Pressed Panini', emoji: '🥪', color: 0xd9a662 },
  CHOWDER:    { dish: 'Clam Chowder', emoji: '🥣', color: 0xe8d9b3 },
  TAHINI:     { dish: 'Tahini Drizzle', emoji: '🥣', color: 0xe8d9b3 },
  SRIRACHA:   { dish: 'Sriracha Squirt', emoji: '🌶️', color: 0xd9453a },
  MARINARA:   { dish: 'Marinara Dunk', emoji: '🍅', color: 0xc4304a },
  ALFREDO:    { dish: 'Alfredo Pour', emoji: '🍝', color: 0xf2ede0 },
  SAFFRON:    { dish: 'Saffron Threads', emoji: '🌼', color: 0xe8893b },
  ROSEMARY:   { dish: 'Rosemary Sprig', emoji: '🌿', color: 0x4a7a3a },
  TURMERIC:   { dish: 'Golden Turmeric', emoji: '🟡', color: 0xe8b43b },
  PARMESAN:   { dish: 'Parmesan Shavings', emoji: '🧀', color: 0xf2e8c0 },
  RICOTTA:    { dish: 'Ricotta Dollop', emoji: '🧀', color: 0xf6f3ec },
  GNOCCHI:    { dish: 'Pillowy Gnocchi', emoji: '🥔', color: 0xe8d9b3 },
  SCALLOP:    { dish: 'Seared Scallop', emoji: '🦪', color: 0xf2e8dc },
  OCTOPUS:    { dish: 'Grilled Octopus', emoji: '🐙', color: 0x9a5fb3 },
  SCALLION:   { dish: 'Scallion Curls', emoji: '🌱', color: 0x6bb35e },
  PLANTAIN:   { dish: 'Fried Plantain', emoji: '🍌', color: 0xe8b43b },
  LYCHEE:     { dish: 'Lychee Pearls', emoji: '⚪', color: 0xf2dce0 },
  TENTACLE:   { dish: 'Wiggly Tentacle', emoji: '🦑', color: 0xc4306b },
  GIZZARD:    { dish: 'Fried Gizzards', emoji: '🍗', color: 0xc99a6b },
  CALZONE:    { dish: 'Stuffed Calzone', emoji: '🥟', color: 0xe8b45e },
  POUTINE:    { dish: 'Cheesy Poutine', emoji: '🍟', color: 0xc9853b },
  STRUDEL:    { dish: 'Apple Strudel', emoji: '🥐', color: 0xe8b45e },
  NOUGAT:     { dish: 'Almond Nougat', emoji: '🍬', color: 0xf2e8c0 },
  PRALINE:    { dish: 'Pecan Praline', emoji: '🍬', color: 0xc9925e },
  MACARON:    { dish: 'Rainbow Macaron', emoji: '🌈', color: 0xe89ac4 },
  CANNOLI:    { dish: 'Sweet Cannoli', emoji: '🥐', color: 0xe8d9b3 },
  TURNOVER:   { dish: 'Cherry Turnover', emoji: '🥧', color: 0xe8b45e },
  POMELO:     { dish: 'Giant Pomelo', emoji: '🍊', color: 0xe8c98a },
  CHICKPEA:   { dish: 'Crunchy Chickpeas', emoji: '🧆', color: 0xe8d9b3 },
  MARMALADE:  { dish: 'Orange Marmalade', emoji: '🍊', color: 0xe8843b },
  MOLASSES:   { dish: 'Sticky Molasses', emoji: '🍯', color: 0x4a3320 },
  TERIYAKI:   { dish: 'Teriyaki Glaze', emoji: '🍢', color: 0x6b4226 },
  CARDAMOM:   { dish: 'Cardamom Pods', emoji: '🟢', color: 0x9bc96b },
  CORIANDER:  { dish: 'Coriander Seeds', emoji: '🌿', color: 0x9b8b4f },
  PEPPERCORN: { dish: 'Cracked Peppercorn', emoji: '⚫', color: 0x3a3326 },
  PEPPERONI:  { dish: 'Pepperoni Stack', emoji: '🍕', color: 0xc4304a },
  GRAPEFRUIT: { dish: 'Ruby Grapefruit', emoji: '🍊', color: 0xe86b6b },
  BLACKBERRY: { dish: 'Blackberry Bramble', emoji: '🫐', color: 0x3a2a4f },
  TANGERINE:  { dish: 'Tangerine Twist', emoji: '🍊', color: 0xe8843b },
  DRAGONFRUIT: { dish: 'Dragonfruit Slice', emoji: '🐉', color: 0xd93a6b },
  BISCOTTI:   { dish: 'Almond Biscotti', emoji: '🍪', color: 0xc9925e },
};
...
// Expansion-2 words, merged into the grade tiers above so menus vary more
// and repeat far less often.
const GRADE_TIERS_EXTRA = {
  0: [[], [], []],
  1: [['SALT', 'GOO'], ['BLOB', 'SPAM'], ['BUGS', 'STEW']],
  2: [['MAYO', 'SALSA', 'RANCH', 'SAUCE', 'DILL', 'SAGE', 'MACE', 'BRIE', 'FETA'], ['TOFU', 'GYRO', 'BEET', 'OKRA', 'WORMS', 'SLIME', 'GUMMY', 'GIANT', 'FROG'], ['GLOOP', 'DATE', 'WINGS', 'FRIES', 'ROLLS', 'PUNCH', 'SLUSH', 'SHAKE', 'COCOA']],
  3: [['GRAVY', 'SYRUP', 'RELISH', 'PESTO', 'HUMMUS', 'CURRY', 'BROTH', 'CHILI', 'BASIL', 'GINGER', 'CLOVE', 'CHIVE', 'GOUDA', 'SWISS', 'BAGEL'], ['DONUT', 'SUSHI', 'KEBAB', 'NACHOS', 'JERKY', 'SALAMI', 'CELERY', 'SQUASH', 'ORANGE', 'BRAINS', 'STINKY', 'TONGUE', 'SNAIL', 'SQUID', 'RAMEN'], ['SUNDAE', 'FUDGE', 'WAFER', 'SCONE', 'CREPE', 'ALMOND', 'WALNUT', 'PECAN', 'RAISIN', 'PRUNE', 'CHERRY', 'LATTE', 'CIDER', 'MOCHA', 'WAFFLE']],
  4: [['AIOLI', 'CHUTNEY', 'VINEGAR', 'WASABI', 'GUMBO', 'THYME', 'CUMIN', 'NUTMEG', 'PARSLEY', 'CHEDDAR', 'RAVIOLI', 'SAUSAGE', 'BOLOGNA'], ['LOBSTER', 'BRISKET', 'SHALLOT', 'FENNEL', 'APRICOT', 'PAPAYA', 'GUAVA', 'PARSNIP', 'EYEBALL', 'MYSTERY', 'CRICKET', 'DURIAN', 'HAGGIS'], ['SPROUT', 'QUICHE', 'SORBET', 'GELATO', 'PARFAIT', 'TOFFEE', 'CARAMEL', 'ECLAIR', 'COBBLER', 'TRIFLE', 'CASHEW', 'LENTIL', 'PANINI', 'CHOWDER']],
  5: [['TAHINI', 'SRIRACHA', 'MARINARA', 'ALFREDO', 'SAFFRON', 'ROSEMARY', 'TURMERIC', 'PARMESAN', 'RICOTTA'], ['GNOCCHI', 'SCALLOP', 'OCTOPUS', 'SCALLION', 'PLANTAIN', 'LYCHEE', 'TENTACLE', 'GIZZARD', 'CALZONE'], ['POUTINE', 'STRUDEL', 'NOUGAT', 'PRALINE', 'MACARON', 'CANNOLI', 'TURNOVER', 'POMELO', 'CHICKPEA']],
  6: [['MARMALADE', 'MOLASSES', 'TERIYAKI', 'CARDAMOM'], ['CORIANDER', 'PEPPERCORN', 'PEPPERONI', 'GRAPEFRUIT'], ['BLACKBERRY', 'TANGERINE', 'DRAGONFRUIT', 'BISCOTTI']],
};
for (const g of Object.keys(GRADE_TIERS_EXTRA)) {
  GRADE_TIERS_EXTRA[g].forEach((arr, t) => { if (arr.length) GRADE_TIERS[g][t].push(...arr); });
}
